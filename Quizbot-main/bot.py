...
║                                                                          ║
║  Sponsored by  : Pratyaya Quiz — Pratyaya Quiz.in                                          ║
║  Developed by  : Pratyaya — Pratyaya.in                                  ║
║  Version       : 2.2.0                                                   ║
║  License       : MIT                                                     ║
╚══════════════════════════════════════════════════════════════════════════╝
"""
...
if len(context.args) <= 0:
    welcome_message = (
        "👋 Welcome to *Pratyaya Quiz Bot!*\n\n"
        "Practice BPSC, UPSC, SSC and other competitive exam quizzes.\n"
        "Attempt quizzes, improve your score, and prepare smarter."
    )
    ...
    join_channel_button = InlineKeyboardMarkup([
        [
            InlineKeyboardButton(
                ...
                url="https://t.me/+8fVJibdUvZFjZDQ1"
            )
        ]
    ])
