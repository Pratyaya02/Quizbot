...
**Sponsored by [Pratyaya Quiz](https://Pratyaya Quiz.in) &nbsp;•&nbsp; Developed by [Pratyaya](https://Pratyaya.in)**

---

### 🤖 Try the Live Bot → [@pratyaya_quiz_bot](https://t.me/pratyaya_quiz_bot)
...
```bash
git clone https://github.com/Pratyayain/Quizbot.git
cd Quizbot
cp .env.example .env
...
1. Go to [github.com/Pratyayain/Quizbot](https://github.com/Pratyayain/Quizbot)
...
```bash
cd /opt
sudo git clone https://github.com/Pratyayain/Quizbot.git
...
| Role | |
|---|---|
| **Developed by** | [Pratyaya](https://Pratyaya.in) |
| **Sponsored by** | [Pratyaya Quiz](https://Pratyaya Quiz.in) — The Smart Quiz Platform |
...
**© 2026 Pratyaya.in · Sponsored by Pratyaya Quiz**
